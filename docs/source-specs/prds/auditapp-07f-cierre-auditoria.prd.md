...
- [x] ~~Definir el JSON canónico~~ — **✅ Lo define SyS (el pipeline n8n no existe aún): [07i Contrato de datos](auditapp-07i-contrato-datos-ia.prd.md). El pipeline se adapta a este contrato.**
...
*Status: DRAFT. Spec de referencia completa en [`specs/07f-cierre-auditoria/spec.md`](../../specs/07f-cierre-auditoria/spec.md).*
