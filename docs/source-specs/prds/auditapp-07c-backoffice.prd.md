...
- **Secondary — Técnico (Facu/Simón)**: también accede al tablero, **crea auditorías** y ve resultados de todas (ver [07b](auditapp-07b-auth-roles.prd.md)). No gestiona usuarios ni plantillas.
...
- Dashboard con métricas agregadas / estudio de mercado — **v2** (el modelo de datos ya recopila todo desde v1; ver [07i §6](auditapp-07i-contrato-datos-ia.prd.md)). Es deseado, no MVP.
...
*Status: DRAFT. Spec de referencia completa en [`specs/07c-backoffice/spec.md`](../../specs/07c-backoffice/spec.md).*
