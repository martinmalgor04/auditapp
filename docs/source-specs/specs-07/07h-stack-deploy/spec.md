...
| **Auth** | propia (argon2id + tabla `session`, cookie) | Sin proveedor externo ([07b](../07b-auth-roles/spec.md)) |
| **Storage** | Cloudflare R2 vía S3 SDK / `aws4fetch` | Presigned URLs ([07g](../07g-storage-r2/spec.md)) |
...
- Autorización en cada load/action ([07b](../07b-auth-roles/spec.md)).
...
- Consume el esquema de [SPEC-07a](../07a-modelo-datos/spec.md) y materializa lo de [07b](../07b-auth-roles/spec.md)–[07g](../07g-storage-r2/spec.md).
