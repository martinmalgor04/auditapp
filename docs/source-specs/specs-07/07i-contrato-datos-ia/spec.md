...
- **Produce el contrato**: [SPEC-07f cierre](../07f-cierre-auditoria/spec.md) materializa este JSON.
- **Scoring determinístico**: [SPEC-07f §2](../07f-cierre-auditoria/spec.md) define cómo se autocalculan los scores que viajan en el JSON.
- **Datos de origen**: [SPEC-07a modelo](../07a-modelo-datos/spec.md).
- **Consumidores aguas abajo**: SPEC-08 (pipeline IA + estudio de mercado), SPEC-00 §1/§4.
- **Dashboard**: [SPEC-07c backoffice](../07c-backoffice/spec.md) (v2).
