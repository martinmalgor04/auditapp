...
- **Badges de estado** con el color del flujo (`borrador` … `cerrada`, ver [07a §4](../02-modelo-datos/spec.md)).
...
- Borrado lógico (`archived_at`). Los adjuntos R2 se encolan para borrado diferido ([07g](../06-storage-r2/spec.md)).

---

## 4. Gestión de plantillas (data-driven)

Editor de las plantillas que viven en DB ([07a §3.1](../02-modelo-datos/spec.md)):
...
- Datos: [SPEC-07a](../02-modelo-datos/spec.md). Permisos: [SPEC-07b](../03-auth-roles/spec.md).
- El link de briefing apunta a [SPEC-07d](../05-briefing-externo/spec.md).
- El progreso/score que muestra viene de [07e](../07-form-tecnico-mobile/spec.md) y [07f](../08-cierre-auditoria/spec.md).
