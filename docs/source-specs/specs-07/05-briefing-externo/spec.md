...
- URL: `/briefing/{public_token}` — el token (generado en backoffice, [07c](../04-backoffice/spec.md)) es la única credencial.
...
- **Autosave** igual que el form técnico ([07e](../07-form-tecnico-mobile/spec.md)): si el cliente cierra y vuelve con el mismo link, retoma donde quedó.
...
- Token largo, aleatorio, no enumerable (ver [07b §3](../03-auth-roles/spec.md)).
...
- Token y estados: [SPEC-07b](../03-auth-roles/spec.md), [SPEC-07a §4](../02-modelo-datos/spec.md).
- Render data-driven y autosave: comparte motor con [SPEC-07e](../07-form-tecnico-mobile/spec.md).
