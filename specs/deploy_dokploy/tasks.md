# Tasks — deploy_dokploy

Implementación en orden. Marcar `[x]` al completar. Requiere `stack_scaffolding` (#1) y `modelo_datos` (#2) implementados; PWA plugin de `form_tecnico` (#7) para R11–R12. Documentar trazabilidad R→test en `progress/impl_deploy_dokploy.md`.
...
- [ ] T30 — Documentar trazabilidad R→test en `progress/impl_deploy_dokploy.md`. Cubre: todos.
