...
- [x] T1 — Crear `migrations/030_escaneo_modelo_datos.sql` (tablas `escaneo`,
...
- [x] T2 — Crear `src/lib/server/escaneos/schemas.ts` (enums Zod,
...
- [x] T8 — Gates: `pnpm test`, `pnpm run check`, `pnpm run build`, `./init.sh`
