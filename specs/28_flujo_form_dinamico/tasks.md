...
- [ ] **T1** — Crear `src/lib/client/form/item-status.ts` con las funciones
...
- [ ] **T2** — Crear `tests/form-dynamic-flow.test.ts` con los tests de
  `itemStatus`:
...
- [ ] **T3** — Crear `src/lib/client/form/next-pending.ts` con la función
  `nextPending` y el tipo `PendingTarget` según design.md §3.
  Cubre: R9, R10, R11, R12, R13.

- [ ] **T4** — Agregar tests de `nextPending` en `tests/form-dynamic-flow.test.ts`:
...
- [ ] **T5** — Modificar `src/lib/components/form/field-renderer.svelte`:
...
- [ ] **T6** — Modificar `src/lib/components/form/live-section-score.svelte`:
...
- [ ] **T7** — Modificar `src/lib/components/form/section-nav.svelte`:
...
- [ ] **T8** — Modificar `src/routes/(app)/auditorias/[id]/form/+page.svelte` —
...
- [ ] **T9** — Modificar `+page.svelte` — parte 2: pasar props a componentes:
...
- [ ] **T10** — Modificar `+page.svelte` — parte 3: trigger de animación del score:
...
- [ ] **T11** — Modificar `+page.svelte` — parte 4: botón "próximo pendiente":
...
- [ ] **T12** — Agregar tests en `tests/form-dynamic-flow.test.ts` —
