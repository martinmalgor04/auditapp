...
Se carga en la pantalla de cierre y se guarda en `audit_closure` ([07a §3.3](../07a-modelo-datos/spec.md)):
...
- Scores y respuestas: [SPEC-07e](../07e-form-tecnico-mobile/spec.md) + [SPEC-07a](../07a-modelo-datos/spec.md).
