# Requirements — #5 05_briefing_externo

> Formulario público `/briefing/[token]` para que el cliente complete ítems `filled_by=cliente`.
> Fuente: `docs/source-specs/specs-07/05-briefing-externo/spec.md`, PRD 07d.
> Depende de: `02_modelo_datos` (#2), `03_auth_roles` (#3), `04_backoffice` (#4).
