# Requirements — cierre_scoring

> Motor de scoring determinístico (3 niveles), pantalla de cierre, preview del informe y confirmación/reapertura.
> Depende de: `modelo_datos` (#2), `auth_roles` (#3), `backoffice` (#4), `form_tecnico` (#7).
> Fuera de alcance: endpoint JSON canónico versionado (`contrato_datos` #9), informe final branded/PDF/Loom (SPEC-08), scoring de inventario con IA generativa (v2).
