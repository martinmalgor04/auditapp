# Tasks — cierre_scoring

Implementación en orden. Marcar `[x]` al completar. Documentar trazabilidad R→test en `progress/impl_cierre_scoring.md`.

**Precondición:** features `stack_scaffolding` (#1), `modelo_datos` (#2), `auth_roles` (#3), `backoffice` (#4) y `form_tecnico` (#7) en `done`.
...
- [ ] T25 — Documentar trazabilidad R→test en `progress/impl_cierre_scoring.md`. Cubre: todos.
