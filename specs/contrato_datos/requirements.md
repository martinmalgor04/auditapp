...
> Depende de `cierre_scoring` (#8) para motor de scoring, `audit_closure` y pantalla de cierre.
> Fuentes: `docs/source-specs/specs-07/07i-contrato-datos-ia/spec.md`, `docs/source-specs/prds/auditapp-07i-contrato-datos-ia.prd.md`.
