# Tasks — contrato_datos

Implementación en orden. Marcar `[x]` al completar. Documentar trazabilidad R→test en `progress/impl_contrato_datos.md`.

**Prerequisito:** `cierre_scoring` (#8) en `done` (motor scoring, `audit_closure`, pantalla cierre base).
...
- [ ] T24 — Documentar trazabilidad R→test en `progress/impl_contrato_datos.md`. Cubre: todos.
