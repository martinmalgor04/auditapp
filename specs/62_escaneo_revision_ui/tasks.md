...
- [x] T1 — Crear `migrations/032_escaneo_revision_vinculo.sql`: columnas
...
- [x] T2 — Agregar en `src/lib/server/escaneos/schemas.ts` los schemas
...
- [x] T3 — Crear `src/lib/escaneos/escaneo-view.ts` con
...
- [x] T4 — Crear `src/lib/server/escaneos/consolidado.ts` con
...
- [x] T5 — Agregar en `consolidado.ts`:
...
- [x] T6 — Crear `src/lib/server/escaneos/revision.ts` con
...
- [x] T7 — Crear `tests/escaneos-consolidado.test.ts` según la tabla de
  ...
  R27, R28.
- [x] T8 — Crear `tests/escaneos-revision.test.ts` según la tabla de casos
...
- [x] T10 — Crear
  ...
  R30, R31.
- [x] T11 — Agregar actions `emitirToken`/`revocarToken` en el
...
- [x] T14 — Crear `tests/escaneos-revision-routes.test.ts` (patrón
