...
- [ ] T1 — Verificar que `01_stack_scaffolding` (#1) dejó carpeta `src/lib/server/storage/` y vars R2 en `.env.example`. Cubre: **R11**.
- [ ] T2 — Verificar que `02_modelo_datos` (#2) creó tablas `attachment` y `audit_response` con constraints de 07a. Cubre: **R8, R9**.
...
- [ ] T22 — Documentar trazabilidad R→test en `progress/impl_06_storage_r2.md`. Cubre: todos.
