# Requirements — #6 06_storage_r2

> Módulo server de presigned URLs Cloudflare R2 y persistencia de `attachment`.
> Fuente: SPEC-07g, PRD auditapp-06-storage-r2.
> Fuera de alcance: compresión/HEIC en cliente (`07_form_tecnico` #7), thumbnails backoffice, subida desde briefing cliente (v1).
