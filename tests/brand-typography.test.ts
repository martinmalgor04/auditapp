...
describe('brand typography', () => {
  it('root layout loads Montserrat and sets sys font on body', () => {
    ...
    expect(layout).toContain('wght@300;400;500;600;700;800');
    expect(layout).toContain('font-sys-base');
    expect(appCss).toContain('font-family: var(--sys-font-base, var(--sys-font))');
  });
});
